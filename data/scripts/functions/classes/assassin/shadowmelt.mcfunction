...
execute as @a[scores={spellcast=1,class=3}] run item replace entity @s weapon.offhand with air 1
...
execute as @a[scores={spellcast=1,class=3}] run item replace entity @s armor.head with air 1
execute as @a[scores={spellcast=1,class=3}] run item replace entity @s armor.chest with air 1
execute as @a[scores={spellcast=1,class=3}] run item replace entity @s armor.feet with air 1
